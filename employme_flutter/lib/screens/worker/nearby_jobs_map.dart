    ...
    return TapScale(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        Container(
          ...
          child: Row(
            ...
            children: [
              ...
              Text('${item['time']}m', style: TextStyle(fontSize: 10, fontWeight: FontWeight.w800, color: isUrgent ? Colors.white : AppColors.text)),
            ],
          ),
        ),
        ...
        Container(
          ...
          child: Text((item['emoji'] ?? (isEmployer ? '👤' : '🏪')) as String, style: const TextStyle(fontSize: 16)),
        ),
      ]),
    );
  }
    ...
    return Container(
      ...
      child: Row(children: [
        ...
        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(isEmployer ? 'Your Job Locations' : 'Nearby Jobs', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w700)),
    ...
    child: Column(children: [
      ...
      Padding(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Text(context.read<AppState>().isEmployer ? 'Your Postings' : '${_dynamicJobs.length} jobs nearby', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w700)),
          Container(
            padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
          ...
          children: [
            Row(children: [
              Container(
                ...
                alignment: Alignment.center,
                child: Text((item['emoji'] ?? (isEmployer ? '👤' : '🏪')) as String, style: const TextStyle(fontSize: 22)),
              ),
              const SizedBox(width: 12),
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Row(children: [
                  Text(item['title'] as String, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w700)),
                  if (isUrgent) ...[const SizedBox(width: 6),
                    Container(padding: const EdgeInsets.symmetric(horizontal: 6, vertical: 1), decoration: BoxDecoration(color: AppColors.alert.withOpacity(0.1), borderRadius: BorderRadius.circular(4)),
                      child: Text(isEmployer ? 'READY' : 'URGENT', style: const TextStyle(fontSize: 9, fontWeight: FontWeight.w700, color: AppColors.alert)))],
                ]),
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                Text((item['salary'] ?? '₹500/day') as String, style: const TextStyle(fontSize: 14, fontWeight: FontWeight.w800, color: AppColors.primary)),
                ...
                Container(
                  ...
                  child: Text('AI Match: ${item['score']}%', style: const TextStyle(fontSize: 10, fontWeight: FontWeight.w800, color: AppColors.primaryDark)),
                ),
              ]),
            ]),
